# Security Policy — Magrathean UK Profile

## Private Reporting

Report vulnerabilities through GitHub private vulnerability reporting or email `contact@magrathean.uk` with subject `SECURITY: Magrathean UK Profile`.
